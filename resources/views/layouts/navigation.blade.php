            ...
            <div class="flex-grow flex items-center justify-center px-4 lg:px-8">
                <form action="{{ route('search') }}" method="GET" class="w-full max-w-md">
                    <div class="relative">
                        ...
                        <input type="search" name="q" value="{{ request()->get('q') }}" placeholder="Cari template..."
                               class="block w-full rounded-md border-0 bg-slate-800 py-2 pl-10 text-gray-200 ring-1 ring-inset ring-slate-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                    </div>
                </form>
            </div>
