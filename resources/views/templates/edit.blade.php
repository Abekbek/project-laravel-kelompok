                ...
                <div class="p-6 md:p-8 text-gray-100">
                    ...
                    <form method="POST" action="{{ route('templates.update', $template) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-700 bg-gray-900 text-gray-300 rounded-md shadow-sm">{{ old('description', $template->description) }}</textarea>
                        </div>
                ...
                <div class="p-6 md:p-8 text-gray-100">
                    ...
                    <form method="POST" action="{{ route('items.store', $template) }}" enctype="multipart/form-data" class="mb-6">
                        ...
                        <div>
                            ...
                            <input id="items" name="items[]" type="file" multiple accept="image/*" class="block w-full mt-1 text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-slate-700 file:text-gray-300 hover:file:bg-slate-600">
